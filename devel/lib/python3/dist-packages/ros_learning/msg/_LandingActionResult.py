...
"""autogenerated by genpy from ros_learning/LandingActionResult.msg. Do not edit."""
import codecs
import sys
...
class LandingActionResult(genpy.Message):
  ...
  _type = "ros_learning/LandingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_learning/LandingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ros_learning.msg.LandingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ros_learning.msg.LandingResult()
