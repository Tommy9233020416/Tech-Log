...
# 3. Explicitly export PX4 and XTDrone ROS_PACKAGE_PATHs
...
# 4. NORMAL SPEED MODE for Evaluation
# Set simulation speed to 1.0 (real-time) for smooth visualization and testing
export PX4_SIM_SPEED_FACTOR=1

# 5. Launch the simulation
echo "Starting NORMAL SPEED (1X) simulation environment for evaluation..."
